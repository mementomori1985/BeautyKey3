          ...
          <div className="row mt-3">
            {behavior !== 'create' && (
              <div className="col-12 my-3">
                <Message
                  ...
                  description="Peça para o cliente baixar o app"
                />
            ...
            <div className="form-group col-6">
              ...
              <select
                ...
                onChange={(e) => setClientes('genero', e.target.value)}
              >
            ...
            config={[
...

              {
                ...
                content: (genero) => {
                  switch (genero) {
                    case 'cisgênero':
                      return <Tag color="red">Cisgênero</Tag>;
                    case 'transgênero':
                      return <Tag color="green">Transgênero</Tag>;
                    case 'não binário':
                      return <Tag color="blue">Não Binário</Tag>; // new option
                    default:
                      return <Tag color="gray">Outro</Tag>; // optional default value
                  }
                },
                sortable: true,
              },
